        ...
        <div class="roledetails">
          ...
          <el-form>
            <el-form-item label="角色编码：">
              <el-input v-model="params.code" type="text" placeholder="编码"/>
            </el-form-item>
            ...
            <el-form-item>
              <el-button type="primary" @click="newRole">保存</el-button>
            </el-form-item>
          </el-form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    newRole() {
      this.$http.post(this.$api.role.SAVE, this.params).then(res => {
